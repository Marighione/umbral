        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-10 md:gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <a
              ...
              className="mt-3 inline-flex items-center justify-center md:justify-start gap-2 text-white/70 hover:text-white transition-colors duration-200"
            >
              ...
              <span className="text-[14px]">11 5238-0950</span>
            </a>
          </div>
